...
module.exports = function ManageNewBloggerUsersActionControllerModule(pb) {
    
    //pb dependencies
    var util = pb.util;

    function ManageNewBloggerUsersActionController() {}
    util.inherits(ManageNewBloggerUsersActionController, pb.BaseController);

    ManageNewBloggerUsersActionController.prototype.render = function(cb) {
        var self = this;
        var dao = new pb.DAO();
    ...
    ManageNewBloggerUsersActionController.getRoutes = function(cb) {
        var routes = [
            {
                method: 'post',
                path: '/actions/admin/plugins/blogger_import/settings/manage_new_users',
                auth_required: true,
    ...
    //exports
    return ManageNewBloggerUsersActionController;
};
